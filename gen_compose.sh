...
services=("portainer" "pgadmin" "rabbitmq" "minio-console" "minio" "qdrant" "typebot-ui" "n8n" "chatwoot-app" "evolution")
domains=($PORTAINER_DOMAIN $PGADMIN_DOMAIN $RABBITMQ_DOMAIN $MINIO_CONSOLE_DOMAIN $MINIO_SERVER_DOMAIN $QDRANT_DOMAIN $TYPEBOT_UI_DOMAIN $N8N_DOMAIN $CHATWOOT_DOMAIN $EVOLUTION_DOMAIN)
ports=($PORTAINER_PORT $PGADMIN_PORT $RABBITMQ_MANAGEMENT_PORT $MINIO_CONSOLE_PORT $MINIO_SERVER_PORT $QDRANT_PORT $TYPEBOT_PORT $N8N_PORT $CHATWOOT_PORT $EVOLUTION_PORT)
